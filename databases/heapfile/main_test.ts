...
//     assertEquals(
//       decodeString(encodeString(value.genres as string)),
//       value.genres as string
//     );
//     assertEquals(
//       decodeString(encodeString(value.title as string)).length,
//       (value.title as string).length
//     );
//     assertEquals(
//       value.movieId as string,
//       String(decodeNumber(encodeNumber(Number(value.movieId))))
//     );
